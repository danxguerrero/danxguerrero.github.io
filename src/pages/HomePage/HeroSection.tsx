const HeroSection = () => {
    return <div className="bg-slate-900 text-slate-50 flex flex-col items-center justify-center pt-12 px-2">
        <div className="w-full md:max-w-5xl flex flex-col items-center ">
            <div className="text-center text-5xl md:text-7xl mb-6">Building <span className="text-cyan-500">scalable</span> software solutions for the modern web.</div>
            ...
            <div className="flex justify-center m-12 text-lg w-full">
                <button className="bg-cyan-500 hover:border hover:border-slate-50 text-slate-50 rounded-lg px-3 py-2 mr-3">View My Work</button>
                <button className="border border-slate-50 hover:border-cyan-500 hover:text-cyan-500 px-3 py-2 rounded-lg">Get in Touch</button>
            </div>
        </div>
    </div>
}
